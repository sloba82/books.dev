<div class="col-md-6 col-md-offset-3" ng-controller="HomeCtrl">
    <div>
        <h4>{{ trans('master.register') }}</h4>
    </div>
    <div>
        <form name="form" id='form' ng-submit="createUser()" autocomplete="off" novalidate>
            <fieldset>
                <div>
            ...
            <div>
                ...
                <button type="submit" ng-disabled="form.$invalid" class="btn btn-primary">Create</button>
                <a  ng-href="#/home"><button class="btn btn-success">Back</button></a>
            </div>
        </form>
    </div>
</div>
