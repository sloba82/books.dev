                    ...
                    <div>
                        ...
                        <div>
                            <input id="title_eng"
                                   ...
                                   class="form-control"
                                   required
                                   ng-model="selected_book.title_eng"
                                   ng-maxlength="256">
                    ...
                    <div>
                        ...
                        <div>
                            <input id="title_srb"
                                   ...
                                   class="form-control"
                                   required
                                   ng-model="selected_book.title_srb"
                                   ng-maxlength="256">
                            <span class="text-danger"
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <textarea rows="4" cols="50" name="comment" form="form"
                                      ...
                                      class="form-control"
                                      required
                                      ng-model="selected_book.discription_short"
                                      ng-minlength="16"
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <textarea rows="10" cols="50" name="comment" form="form"
                                      ...
                                      class="form-control"
                                      required
                                      ng-model="selected_book.discription_long"
                                      ng-minlength="64"
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <input id="page_num"
                                   ...
                                   class="form-control"
                                   required
                                   ng-model="selected_book.page_num"
                                   [ng-min="1"]
                                   [ng-max="10000"]>
                            <span class="text-danger"
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <input id="deadline"
                                   ...
                                   class="form-control"
                                   required
                                   ng-model="selected_book.deadline"
                                   ng-minlength="4"
                                   ng-maxlength="32">
                            <span class="text-danger"
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <input id="book_cover"
                                   ...
                                   class="form-control"
                                   required
                                   ng-model="selected_book.book_cover"
                                   ng-minlength="4"
                                   ng-maxlength="32">
                            <span class="text-danger"
