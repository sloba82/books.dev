    <section id="main-slider" class="no-margin">
        <div class="carousel slide wet-asphalt">
            ...
            <div class="carousel-inner">
                <div class="item active" style="background-image: url('app/bower_components/bootstrap/dist/images/slider/bg1.jpg')">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="item" style="background-image: url('app/bower_components/bootstrap/dist/images/slider/bg2.jpg')">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
